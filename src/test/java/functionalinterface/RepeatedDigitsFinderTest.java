...
public class RepeatedDigitsFinderTest {
    ...
    void testRepeatedDigits() {
        ...
        assertEquals(Arrays.asList(7, 8), repeatedDigitsFinder.findRepeatedDigits(1234567788));

        // Test Case 3: Repeated digits at the beginning
        assertEquals(Arrays.asList(1), repeatedDigitsFinder.findRepeatedDigits(112345678));
